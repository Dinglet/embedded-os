/**
 * @file lab3-1_driver.c
 *
 * @brief A device driver - GPIO Driver
 *
 * @details This driver controls 4 LEDs connected to GPIO pins.
 *   Tested with Raspberry Pi Linux 6.1.77-rt24-v8+
 *
 * @author EmbeTronicX
 *
 * @author HUANG, SHIEN-TING
 *
...
MODULE_AUTHOR("HUANG, SHIEN-TING <10545636+Dinglet@users.noreply.github.com>");
MODULE_DESCRIPTION("A device driver - GPIO Driver");
MODULE_VERSION("1.00");
